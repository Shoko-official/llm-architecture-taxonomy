...
```text
docs/architecture/<issue-id>-short-name
feat/architecture/<issue-id>-short-name
fix/architecture/<issue-id>-short-name
```
...
* no taxonomy content appears before the right milestone;
...
Do not introduce architecture claims as final content unless they are backed by
